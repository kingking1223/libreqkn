...
export { default as ChemChannelPreview } from './ChemChannelPreview'; 
...
export { default as ResultsDropdown } from './UserList'
export { default as MathChannelPreview } from './MathChannelPreview'
export { default as ProgChannelPreview } from './ProgChannelPreview'
export { default as DirectPreview } from './DirectPreview'